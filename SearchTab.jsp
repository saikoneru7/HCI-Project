...
<br>
			...
			<section class="quote-area pt-100">
				<div class="container">				
                                                    ...
                                                    <center>
                                                        <h3>Search with address</h3> <br>
                           <form action="searchact.jsp" method="POST" style="width: 30%">

 <div class="form-group">
    <label for="UserName">Address</label>
    <input type="text" class="form-control" name="address" placeholder="Enter Address" required id="email">
  </div>
